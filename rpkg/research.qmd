...
**Advanced Semi-Supervised Learning With Uncertainty Estimation for Phase Identification in Distribution Systems** in Proceedings of the IEEE PES General Meeting, 2025  
<span style="display:inline-flex; gap:4px;">
<a class="btn btn-primary btn-sm" href="">Paper</a>
...
**Deep RL-based Volt-VAR Control and Attack Resiliency for DER-integrated Distribution Grids** in Proceedings of the IEEE ISGT, 2024 
<span style="display:inline-flex; gap:4px;">
...
**Deep Learning and Pattern-based Methodology for Multivariable Sensor Data Regression**  in Proceedings of the IEEE ICMLA, 2022
<span style="display:inline-flex; gap:4px;">
...
**Deep Value of Information Estimators for Collaborative Human-Machine Information Gathering** in Proceedings of the ACM/IEEE ICCPS, 2016
<span style="display:inline-flex; gap:4px;">
