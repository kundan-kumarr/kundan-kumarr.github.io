...
<style>
  ...
  .proj-cv strong {
    color: #228B22; /* Green for Computer Vision */
    font-size: 1.05rem;
  }
  .proj-stat strong {
    color: #007BFF; /* Blue for Statistical ML */
    font-size: 1.05rem;
  }
  .proj-drive strong {
    color: #8B0000; /* Dark Red for Self-Driving */
    font-size: 1.05rem;
  }
  .proj-llm strong {
...
<div class="proj-grid">
  <a class="proj-card" href="https://kundan-kumarr.github.io/Zero2LLM-Crafter/">
  ...
  <a class="proj-card" href="https://kundan-kumarr.github.io/statsphere">
...
<a class="proj-card" href="https://kundan-kumarr.github.io/ai-analysis/">
...
<table class="news-table">
  ...
  <col width="85%">
   ...
   <tr>
    ...
    <td>Our paper on <a href="">Bayesian-Optimized Bidirectional Long-Short-Term Memory network for Wind Power Forecasting with Uncertainty Quantification</a> has been accepted to <a href="https://www.sciencedirect.com/science/article/pii/S037877962500848X?dgcid=coauthor"> Journal on Electric Power Systems Research 2025</a>.</td>
  </tr>
