...
::: {.d-inline-flex style="align-items:baseline"}
::: p-2
![](assets/img/BlueDot_Impact_Logo.svg){width="150px" fig-alt="BlueDot Impact logo"}
:::
::: h3
BlueDot Impact
:::
...
<table style="width: 100%; margin-bottom: 0.5rem;">
  <tr>
    <td><strong>AI Safety Fundamentals — Course Participant</strong></td>
    <td style="text-align: right;">
      <span style="
        background-color: #f5f0e9;
        color: #934c2f;
...
::: {.d-inline-flex style="align-items:baseline"}
::: p-2
![](assets/img/isu.png){width="100px" fig-alt="Iowa State University logo"}
:::
::: h3
