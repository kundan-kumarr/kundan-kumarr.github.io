...
To preview or build locally, install Quarto and run:
```bash
quarto preview
```
#### 🛠️ Built With

- [Quarto](https://quarto.org/s) for static site generation 
- [GitHub Pages](https://docs.github.com/en/pages) for hosting
- Markdown, YAML, and CSS customization for structure and design
