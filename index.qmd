...
<!--::: {#hero-heading}
Hi! I'm <strong style="color:#007bff;">Kundan Kumar</strong>, a Ph.D. candidate in Computer Science (minor: Statistics) at Iowa State University and an <strong style="color:#007bff;">AI Safety Research Fellow at Algoverse</strong>. I build safe, uncertainty-aware AI systems for real-world, high-stakes decision-making — spanning smart grids, autonomous systems, and multi-agent environments.

My research centers on physics-informed deep reinforcement learning (DRL) with embedded safety constraints, uncertainty quantification, and adversarial robustness — enabling agents to make reliable decisions under distribution shifts and partial observability. I also develop LLM-integrated frameworks that bridge low-level control with interpretable, language-grounded reasoning, with a growing focus on AI safety evaluations, alignment, and scalable oversight for agentic systems.

Beyond research, I share insights through [Substack](https://neuravp.substack.com/) and [YouTube](https://www.youtube.com/@AIAgentic-007/). Outside of work, I love cooking and ice skating 🛼.
::: -->
...
<style>
  ...
  .proj-drive strong {
    color: #8B0000; /* Blue for Self-Driving */
    font-size: 1.05rem;
  }
  .proj-llm strong {
